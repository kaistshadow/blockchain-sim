...
#ifndef BLEEPEVAL_PERFORMTEST_LIBRARY_SRC_NODE_NODE_H_
#define BLEEPEVAL_PERFORMTEST_LIBRARY_SRC_NODE_NODE_H_
...
class Node : public NodePrimitives {
 ...
 public:
    Node(std::string myIP, int listenPort, NodeType type) : NodePrimitives(myIP, type) {

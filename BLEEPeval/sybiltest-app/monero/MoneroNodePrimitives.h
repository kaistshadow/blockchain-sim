...
#ifndef BLEEPEVAL_SYBILTEST_APP_MONERO_MONERONODEPRIMITIVES_H_
#define BLEEPEVAL_SYBILTEST_APP_MONERO_MONERONODEPRIMITIVES_H_
...
#endif  // BLEEPEVAL_SYBILTEST_APP_MONERO_MONERONODEPRIMITIVES_H_

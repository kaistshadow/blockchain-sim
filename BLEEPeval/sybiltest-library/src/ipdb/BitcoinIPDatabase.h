...
#ifndef BLEEPEVAL_SYBILTEST_LIBRARY_SRC_IPDB_BITCOINIPDATABASE_H_
#define BLEEPEVAL_SYBILTEST_LIBRARY_SRC_IPDB_BITCOINIPDATABASE_H_
...
#endif  // BLEEPEVAL_SYBILTEST_LIBRARY_SRC_IPDB_BITCOINIPDATABASE_H_

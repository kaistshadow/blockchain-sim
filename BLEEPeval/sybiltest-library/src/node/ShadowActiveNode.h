...
#ifndef BLEEPEVAL_SYBILTEST_LIBRARY_SRC_NODE_SHADOWACTIVENODE_H_
#define BLEEPEVAL_SYBILTEST_LIBRARY_SRC_NODE_SHADOWACTIVENODE_H_
...
#endif  // BLEEPEVAL_SYBILTEST_LIBRARY_SRC_NODE_SHADOWACTIVENODE_H_

...
#ifndef BLEEPEVAL_SYBILTEST_LIBRARY_SRC_POLICY_EREBUSATTACKPOLICY_H_
#define BLEEPEVAL_SYBILTEST_LIBRARY_SRC_POLICY_EREBUSATTACKPOLICY_H_
...
#endif  // BLEEPEVAL_SYBILTEST_LIBRARY_SRC_POLICY_EREBUSATTACKPOLICY_H_

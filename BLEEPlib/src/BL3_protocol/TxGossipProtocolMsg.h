...
#ifndef BLEEPLIB_SRC_BL3_PROTOCOL_TXGOSSIPPROTOCOLMSG_H_
#define BLEEPLIB_SRC_BL3_PROTOCOL_TXGOSSIPPROTOCOLMSG_H_
...
#endif  // BLEEPLIB_SRC_BL3_PROTOCOL_TXGOSSIPPROTOCOLMSG_H_

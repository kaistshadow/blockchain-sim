...
def setup_multiple_node_xml(node_num, injector_op, simultime, txnum, miningtime, miningtime_dev):
    base_xml = "real-network.xml"
    new_xml  = "real-network-auto.xml"
...
if __name__ == '__main__':
    ...
    shadow_configfile = "real-network-auto.xml"
    os.system("./addIPHint.py internet_topology500.xml real-network-auto.xml")
    
    shadow_configfile = "newreal-network-auto.xml"

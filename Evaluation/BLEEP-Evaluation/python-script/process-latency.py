...
if __name__ == '__main__':
    ...
    latency_avg_set = []
    print "\n--------------------------------------------------------"
    print "Message ID".ljust(20), "|", "Avg Latency(ms)".rjust(15), "|", "Avg Latency(s)".rjust(15)
    print "--------------------------------------------------------"
    for mid in msg_id_dict:
        arr = msg_id_dict[mid]
        latency_avg = sum(arr, 0.0)/len(arr)
        print str(mid).ljust(20), "|", str(latency_avg).rjust(15), "|", str(latency_avg/1000.0).rjust(15)

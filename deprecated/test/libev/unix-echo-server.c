...
int unix_socket_init(struct sockaddr_un* socket_un, const char* sock_path, int max_queue) {
  int fd;
...
int server_init(struct sock_ev_serv* server, const char* sock_path, int max_queue) {

...
#define ActiveViewSize  5
#define PassiveViewSize 30
#define ARWL 5
#define PRWL 2
#define SRWL 4
#define Ka   3
...
class PartialView {
 ...
 public:
    ...
    bool DropFromPassive(std::string id);
...
class HandleNetwork_GossipModel: public HandleNetwork {
 private:
    ...
    static void Membership_HandleIsolationDetectionCallback(EV_P_ ev_timer *w, int revents);
    void Membership_RegisterShutdownTimerWatcher();
    void Membership_RegisterShuffleTimerWatcher();
    void Membership_RegisterIsolationTimerWatcher();
    void Membership_RestartIsolationTimer();
    ...
    // [Functions for verifying P2P networking protocols]
    // Very basic gossip function (Flooding algoritm)
 ...
 public:
    ...
    void Membership_HandleDisconnect(std::string src);

...
void HandleNetwork_GossipModel::Eclipse_Attack_Callback(EV_P_ ev_timer *w, int revents) {
    ...
    // Add to Active view
    instance->GetPartialViewManager()->AddToActive(target_ip);
    std::cout << "[Eclipse Attack] Send join msg to target\n";
...
void HandleNetwork_GossipModel::Eclipse_Attack_RegisterTimerWatcher() {
    ...
    ev_timer_init(&Eclipse_Attack_Timer, Eclipse_Attack_Callback, eclipseTime, 0.1);
            ...
            case MEMBERSHIP_FORWARDJOIN:
                {
                    ...
                    if (hop == PRWL) {
                        ...
                        //PartialViewManager.PrintActiveView();//problem
                    }

...
// Void elements according to �쏦TML 5.3: The HTML Syntax��:
 ...
 *
 * In other words, the text doesn�셳 contain any newline. Return 0.
 *
 * **Case 2: `textContent` is on the same line as opening tag**:
 *
 * We already know there is atleast one newline, because case 1 didn�셳 return.

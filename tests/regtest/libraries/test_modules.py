            ...
            if tx_condition_count == 0:
                ...
                try:
                    ...
                    if tx_cnt > 0:
                        ...
                        tx_sec = 0
                        xml_command = "cd ../libraries; python xmlGenerator.py" + " " + "1" + " " + sim_time + " " + algo + " " + tx_mode + " " + difficulty + " " + str(
                            tx_cnt) + " " + str(tx_sec) + " " + str(number_bitcoins_transferred) + " " + path
                        break
                ...
                try:
                    number_bitcoins_transferred = float(
                        input("input number of Bitcoins transferred (minimum amount : 0.0000546) : "))
...
def test_file_existence(node_id_list, plugin_list):
    ...
    for i in range(0, len(node_id_list)):
        target_path = path + "/shadow.data/hosts/" + node_id_list[i] + "/stdout-" + node_id_list[i] + "." + plugin_list[
            i] + ".1000.log"
